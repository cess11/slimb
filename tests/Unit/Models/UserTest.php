...
class UserTest extends BaseTestCase
{
    ...
    /** @test */
    public function it_has_favourite_bugs_relationship()
    {
        $user = new User();

        $this->assertInstanceOf(BelongsToMany::class, $user->favouriteBugs());
        $this->assertInstanceOf(Bug::class, $user->favouriteBugs()->getRelated());
