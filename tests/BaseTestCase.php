...
abstract class BaseTestCase extends TestCase
{
     ...
     *
     * @param \Slimbug\Models\User $user
     *
     * @return mixed
     */
     ...
     * @return Bug
     */
    public function createBug($overrides = [])
    {
        $faker = Factory::create();
        $attributes = [
        ...
        return Bug::create(array_merge($attributes, $overrides));
    }
    ...
    public function createComment($overrides = [])
    {
        ...
        $attributes = [
            ...
            'bug_id' => isset($overrides['bug_id']) ? $overrides['bug_id'] : $this->createBug(['user_id' => $user_id])->id,
        ];
